...
const AddProduct: FC = () => {
    ...
    const onFormSubmit = (event: FormEvent<HTMLFormElement>): void => {
        ...
        bodyFormData.append("product", new Blob([JSON.stringify({
            productTitle, productr, year, country, type, volume, productGender, fragranceTopNotes,
            fragranceMiddleNotes, fragranceBaseNotes, price, productRating
                ...
                <form onSubmit={onFormSubmit}>
                    <div className="form row">
                        ...
                        <div className="col">
                            ...
                            <input
                                type="text"
                                className={productrError ? "form-control is-invalid" : "form-control"}
                                name="productr"
                                value={productr}
