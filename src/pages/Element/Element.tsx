...
const Element: FC<RouteComponentProps<{ id: string }>> = ({match}) => {
        ...
        <div className="container mt-5 pb-5">
            {loading ? <Spinner/> : <>
                ...
                <div className="row">
                    ...
                    <div className="col-md-7">
                        ...
                        <table className="table">
                            ...
                            <tr>
                                <td>Top notes:</td>
                                <td>{product.fragranceTopNotes}</td>
                            </tr>
                            <tr>
                                <td>Heart notes:</td>
                                <td>{product.fragranceMiddleNotes}</td>
                            </tr>
                            <tr>
                                <td>Base notes:</td>
                                <td>{product.fragranceBaseNotes}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div className="mt-5">
                    ...
                    <Route exact component={() => <ElementReview data={reviews} itemsPerPage={5}/>}/>
