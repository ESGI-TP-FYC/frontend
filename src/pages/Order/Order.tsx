...
const Order: FC = () => {
    ...
    const onFormSubmit = (event: FormEvent<HTMLFormElement>): void => {
        ...
        if (validateEmailError) {
            ...
            const order = {firstName, lastName, city, address, postIndex, phoneNumber, email, productsId, totalPrice};
                                        ...
                                        <div key={product.id} className="col-lg-6 d-flex align-items-stretch">
                                            <div className="card mb-5">
                                                ...
                                                <div className="card-body text-center">
                                                    ...
                                                    <h6><span>Price: $ {product.price}</span>.00</h6>
                                                    <h6>
                                                        <span>Quantity: {productsFromLocalStorage.get(product.id)}</span>
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
