...
export const FETCH_PRODUCTS_BY_PRODUCTR_SUCCESS = "FETCH_PRODUCTS_BY_PRODUCTR_SUCCESS";
...
export type FetchProductsByProductrSuccessActionType = { type: typeof FETCH_PRODUCTS_BY_PRODUCTR_SUCCESS, payload: Array<Product> };
