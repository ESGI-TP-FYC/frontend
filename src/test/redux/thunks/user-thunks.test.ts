...
import {fetchProductSuccess} from "../../../redux/actions/product-actions";
import {productData} from "../../test-data/product-test-data";
...
describe("user actions", () => {
    ...
    test("addReviewToProduct should dispatches USER_ADDED_REVIEW_FAILURE on failure", async () => {
