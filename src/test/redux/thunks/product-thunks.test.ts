...
describe("product actions", () => {
    ...
    test("fetchProducts should dispatches LOADING_PRODUCT and FETCH_PRODUCTS on success", async () => {
    ...
    test("fetchProduct should dispatches LOADING_PRODUCT and FETCH_PRODUCT_SUCCESS on success", async () => {
    ...
    test("fetchProductsByIds should dispatches LOADING_PRODUCT and FETCH_PRODUCTS on success", async () => {
    ...
    test("fetchProductsByFilterParams should dispatches LOADING_PRODUCT and FETCH_PRODUCTS_BY_FILTER_PARAMS_SUCCESS on success", async () => {
    ...
    test("fetchProductsByGender should dispatches LOADING_PRODUCT and FETCH_PRODUCTS_BY_GENDER_SUCCESS on success", async () => {
    ...
    test("fetchProductsByProductr should dispatches LOADING_PRODUCT and FETCH_PRODUCTS_BY_PRODUCTR_SUCCESS on success", async () => {
    ...
    test("fetchProductsByQuery should dispatches LOADING_PRODUCT and FETCH_PRODUCTS_BY_QUERY_SUCCESS on success", async () => {
    ...
    test("fetchProductByQuery should dispatches FETCH_PRODUCT_BY_QUERY_SUCCESS on success", async () => {
    ...
    test("fetchProductsByIdsQuery should dispatches LOADING_PRODUCT and FETCH_PRODUCTS_BY_QUERY_SUCCESS on success", async () => {
